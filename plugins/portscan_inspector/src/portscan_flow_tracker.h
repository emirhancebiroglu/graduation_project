// portscan_flow_tracker.h — SYN ML + NULL/XMAS heuristic
// 7 features for XGBoost + inline NULL/XMAS detection
...
struct PsiAggProfile {
    ...
    static void preprocess(double* f, const PsiAggScalerParams& p) {
    ...
    // NULL/XMAS: any FIN/NULL/XMAS packet with no SYNs = never normal
    bool is_null_xmas() const { return fnx_count > 0 && syn_count == 0; }
};

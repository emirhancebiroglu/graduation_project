#!/usr/bin/env python3
"""
community_flowid_confusion_wednesday.py — Community Rules confusion matrix (Wednesday only)
...
Kullanım:
    python community_flowid_confusion_wednesday.py \
        --alert-dir ~/bitirme/results/community \
        --csv-dir ~/bitirme/data/raw/cicids2017 \
        --output ~/bitirme/results/community/confusion_matrix_wednesday.txt
"""
...
def main():
    ...
    logging.info("=" * 60)
    logging.info("Community Rules Alert → Flow ID (Wednesday-only, IP haritalama ile)")
    logging.info("=" * 60)
    ...
    result = f"""
{'=' * 60}
Snort3 Community Rules — CIC-IDS2017 Wednesday Confusion Matrix

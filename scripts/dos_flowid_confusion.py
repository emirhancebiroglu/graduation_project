#!/usr/bin/env python3
"""
xgb_flowid_confusion.py — DoS Inspector confusion matrix
...
Kullanım:
    python xgb_flowid_confusion.py \
        ...
        --output ~/bitirme/results/dos_inspector/confusion_matrix.txt
"""
...
def main():
    ...
    logging.info("=" * 60)
    logging.info("DoS Alert → Flow ID (IP haritalama ile)")
    logging.info("=" * 60)
    ...
    result = f"""
{'=' * 60}
DoS Inspector — CIC-IDS2017 Confusion Matrix

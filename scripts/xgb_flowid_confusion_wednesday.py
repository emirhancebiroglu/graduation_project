#!/usr/bin/env python3
"""
xgb_flowid_confusion.py — XGBoost Inspector confusion matrix (Wednesday only)
...
Kullanım:
    python xgb_flowid_confusion.py \
        ...
        --output ~/bitirme/results/xgboost/confusion_matrix_wednesday.txt
"""
...
def main():
    ...
    logging.info("=" * 60)
    logging.info("XGBoost Alert → Flow ID (Wednesday-only, IP haritalama ile)")
    logging.info("=" * 60)
    ...
    result = f"""
{'=' * 60}
XGBoost Inspector — CIC-IDS2017 Wednesday Confusion Matrix

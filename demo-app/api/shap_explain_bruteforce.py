"""SHAP explanation for bruteforce_inspector (10-feature XGBoost + log1p + RobustScaler)."""
...
_MODEL_PATH  = _BASE / "models" / "bruteforce_model_v3.json"
_SCALER_PATH = _BASE / "models" / "bruteforce_model_v3_scaler.json"

---------------------------------------------------------------------------
-- snort_ddos.lua — DDoS Aggregator Config (per-destination-IP aggregation)
---------------------------------------------------------------------------
HOME_NET = 'any'
EXTERNAL_NET = 'any'
...
ips = {
    include = '/home/emirhan/bitirme/configs/ddos_rules.rules',
    variables = default_variables
}
alert_csv = { file = true, }
if ( tweaks ~= nil ) then include(tweaks .. '.lua') end
-- =============================================
-- DDoS Aggregator (per-destination-IP aggregation)
-- =============================================
ddos_aggregator =
{
    threshold    = 0.50,

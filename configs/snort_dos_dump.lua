---------------------------------------------------------------------------
-- snort_dos_dump.lua — DoS Inspector dump mode (feature collection)
-- threshold=0.0 → tüm flows loglanır + dump_path CSV'ye yazılır
-- V1 model kullanır (FROZEN production baseline)
---------------------------------------------------------------------------
...
ips =
{
    include = '/home/emirhan/bitirme/configs/dos_rules.rules',
    variables = default_variables
}

alert_csv = { file = true, }

-- DoS Inspector — dump mode
-- dump_path SET BY CALLER via env/lua override
-- Default uses Monday benign as smoke test
dos_inspector =
{
    threshold   = 0.0,
    max_packets = 2,
    model_path  = "/home/emirhan/bitirme/models/dos_fpr_opt_v2.json",
    dump_path   = "/home/emirhan/bitirme/data/snort_dump/dump_placeholder.csv",
}

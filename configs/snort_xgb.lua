---------------------------------------------------------------------------
-- snort_xgb.lua — XGBoost Inspector Config
-- Bitirme Projesi: IDS Performans Karşılaştırma
-- Bu config xgb_inspector kullanır, ml_inspector içermez.
---------------------------------------------------------------------------
...
ips =
{
    include = '/home/emirhan/bitirme/configs/xgb_rules.rules',
...
-- =============================================
-- XGBoost Inspector (bitirme projesi)
-- =============================================
xgb_inspector =
{
    threshold   = 0.90,

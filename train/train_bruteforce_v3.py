#!/usr/bin/env python3
"""Train bruteforce model v3 — same 10 features as v2, with regenerated wednesday_dump (hard negatives)."""
import numpy as np
...
BENIGN_DUMPS = [
    'monday_dump.txt',
    'wednesday_dump.txt',   # regenerated — contains hard negatives (172.16.0.1, 192.168.10.15)
    'thursday_dump.txt',
]
...
print("=== BruteForce Model v3 Training ===")
...
# Save model + scaler
MODEL_OUT = '/home/emirhan/bitirme/models/bruteforce_model_v3.json'
SCALER_OUT = '/home/emirhan/bitirme/models/bruteforce_model_v3_scaler.json'
